                    ...
                    <div class="card-body">
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="get">
                            <div class="form-group">
                                <input type="date" name="sales1" id="" class="form-control" title="select your desired date"/>
                            </div>
                                <h4 class="text-center">TO</h4>
                            <div class="form-group">
                                <input type="date" name="sales2" id="" class="form-control" title="select your desired date"/>
                            </div>
