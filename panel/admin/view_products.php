...
$view_products = mysqli_query($con, $query);
$count = mysqli_num_rows($view_products);
if ($count > 0) {
    ...
    while ($row=mysqli_fetch_assoc($view_products)) {
        ...
        echo "<td>
            <a href='/supermarket/panel/admin/edit_product_page.php?pid=$id&pn=$pn&pt=$pt&pd=$pd&pq=$tq&cp=$cp&sp=$sp' title='edit product'><i class='fa fa-edit btn btn-primary'> edit product</i></a>
            <hr>
